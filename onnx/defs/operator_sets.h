...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 12, Opmul);
...
class OpSet_Onnx_ver12 {
 public:
  static void ForEachSchema(std::function<void(OpSchema&&)> fn) {
    ...
    fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 12, Opmul)>());
...
class ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 13, Mish);
...
class OpSet_Onnx_ver13 {
 public:
  static void ForEachSchema(std::function<void(OpSchema&&)> fn) {
   ...
   fn(GetOpSchema<ONNX_OPERATOR_SET_SCHEMA_CLASS_NAME(Onnx, 13, Mish)>());
  }
};
